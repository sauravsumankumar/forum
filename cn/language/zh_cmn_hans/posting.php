...
$lang = array_merge($lang, array(
	...
	'ATTACH_COMMENT_NO_EMOJIS'	=> '附件的注释内容包含禁用的字符 (Emoji)。',
	...
	'DELETE_FILE'				=> '删除文件',
	'DELETE_MESSAGE'			=> '删除消息',
	'DELETE_MESSAGE_CONFIRM'	=> '您确认要删除这个消息吗？',
	'DELETE_OWN_POSTS'			=> '对不起，您只能删除自己的帖子。',
	'DELETE_PERMANENTLY'		=> '永久删除',
	'DELETE_POST_CONFIRM'		=> '您确认要删除这篇帖子吗？',
	'DELETE_POST_PERMANENTLY_CONFIRM'	=> '您确定要<strong>永久</strong>删除此贴吗？',
	'DELETE_POST_PERMANENTLY'	=> array(
		1	=> '永久删除 %1$d 帖子，将不再能恢复。',
	),	
	'DELETE_POSTS_CONFIRM'		=> '您确定要删除这些帖子吗？',
	'DELETE_POSTS_PERMANENTLY_CONFIRM'	=> '您确定要<strong>永久</strong>删除这些帖子吗？',
	'DELETE_REASON'				=> '删除理由',
	'DELETE_REASON_EXPLAIN'		=> '指定的删除理由将被版主可见。',
	'DELETE_POST_WARN'			=> '删除的帖子将不能恢复',
	'DELETE_TOPIC_CONFIRM'		=> '您确定要删除此主题吗？',
	'DELETE_TOPIC_PERMANENTLY'	=> array(
		1	=> '永久删除 %1$d 主题，将不再能恢复。',
	),	
	'DELETE_TOPIC_PERMANENTLY_CONFIRM'	=> '您确定要<strong>永久</strong>删除此主题吗？',
	'DELETE_TOPICS_CONFIRM'		=> '您确定要删除这些主题吗？',
	'DELETE_TOPICS_PERMANENTLY_CONFIRM'	=> '您确定要<strong>永久</strong>删除这些主题吗？',
	'DISABLE_BBCODE'			=> '禁止解析 BBCode',
	'DISABLE_MAGIC_URL'			=> '禁止自动生成超链接',
	'DISABLE_SMILIES'			=> '禁止生成表情',
	'DISALLOWED_CONTENT'		=> '上传失败， 因为文件可能包含安全隐患.',
	'DISALLOWED_EXTENSION'		=> '扩展名 %s 是被禁止的',
	'DRAFT_LOADED'				=> '草稿已经导入编辑区，您可以编辑完成您的帖子。<br />您的草稿将在帖子提交后删除。',
	'DRAFT_LOADED_PM'			=> '草稿已经导入编辑区域， 您可以现在完成您的站内短信.<br />您的草稿将在提交后删除.',
	'DRAFT_SAVED'				=> '草稿保存成功',
	'DRAFT_TITLE'				=> '草稿标题',
	...
	'LOGIN_EXPLAIN_BUMP'		=> '您需要登录后才能在这个版面顶贴。',
	'LOGIN_EXPLAIN_DELETE'		=> '您需要登录后才能在这个版面删除帖子。',
	'LOGIN_EXPLAIN_SOFT_DELETE'	=> '您需要登录后才能在这个版面软删除帖子。',
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> array(
		1	=> '您的flash文件可能只允许达到 %d 像素高。',
	),
	'MAX_FLASH_WIDTH_EXCEEDED'	=> array(
		1	=> '您的flash文件可能只允许达到 %d 像素宽。',
	),
	'MAX_IMG_HEIGHT_EXCEEDED'	=> array(
		1	=> '您的图片文件可能只允许达到 %1$d 像素高。',
	),
	'MAX_IMG_WIDTH_EXCEEDED'	=> array(
		1	=> '您的图片文件可能只允许达到 %d 像素宽。',
	),

	'MESSAGE_BODY_EXPLAIN'		=> array(
		0	=> '', // zero means no limit, so we don't view a message here.
		1	=> '输入您的信息在这里，可包含不多于<strong>%d</strong>个字符。',
	),
	'MESSAGE_DELETED'			=> '帖子已被成功删除',
	'MORE_SMILIES'				=> '查看更多表情',

	'NOTIFY_REPLY'				=> '有人回复时，给我发送一封 Email',
	'NOT_UPLOADED'				=> '文件上传失败。',
	...
	'NO_TEMP_DIR'				=> '临时目录不可写或者找不到。',

	'PARTIAL_UPLOAD'			=> '要上传的文件只上传了一部分',
	'PHP_UPLOAD_STOPPED'		=> '一个 PHP 扩展阻止了文件上传。',
	...
	'POLL_OPTIONS_EXPLAIN'		=> array(
		1	=> '每行一个选项，您可以输入最多<strong>%d</strong>个选项。',
	),
	'POLL_OPTIONS_EDIT_EXPLAIN'		=> array(
		1	=> '每行一个选项，您可以输入最多<strong>%d</strong>个选项。如果您移除或添加选项，所有之前的投票将被重置。',
	),
	'POLL_QUESTION'				=> '投票问题',
	'POLL_TITLE_TOO_LONG'		=> '投票的标题不能大于 100 字符.',
	'POLL_TITLE_COMP_TOO_LONG'	=> '解析后的投票标题过长， 请删除一些 BBCode 或表情图标.',
	'POLL_VOTE_CHANGE'			=> '允许重新投票',
	'POLL_VOTE_CHANGE_EXPLAIN'	=> '如果允许，用户将可以更改他们的选择。',
	'POSTED_ATTACHMENTS'		=> '发布的附件',
	'POST_APPROVAL_NOTIFY'		=> '当您的帖子通过审核时会通知您.',
	'POST_CONFIRMATION'			=> '帖子确认',
	...
	'STICKY_ANNOUNCE_TIME_LIMIT'=> '置顶/公告/全局 时间限制',
	'STICK_TOPIC_FOR'			=> '主题置顶时间',
	'STICK_TOPIC_FOR_EXPLAIN'	=> '输入 0 或留空将使主题成为永久全局公告，公告或置顶',
	...
	'UNSUPPORTED_CHARACTERS_MESSAGE'	=> '您的信息包括以下不支持的字符：<br />%s',
	'UNSUPPORTED_CHARACTERS_SUBJECT'	=> '您的主题包括以下不支持的字符：<br />%s',
	'UPDATE_COMMENT'			=> '更新评论',
	'URL_INVALID'				=> '您指定的链接无效。',
	'URL_NOT_FOUND'				=> '指定的文件无法找到。',
	'URL_IS_OFF'				=> '[url] <em>禁止</em>',
	'URL_IS_ON'					=> '[url] <em>允许</em>',
	'USER_CANNOT_BUMP'			=> '您不能在这个版面顶贴',
	'USER_CANNOT_DELETE'		=> '您不能在这个版面删除帖子',
	'USER_CANNOT_EDIT'			=> '您不能在这个版面编辑帖子',
	'USER_CANNOT_REPLY'			=> '您不能在这个版面回复主题',
