...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> '简体中文语言由 <a href="https://www.phpbbchinese.com/">phpBB Chinese</a> 制作并提供支持',
	'DIRECTION'			=> 'ltr',
	...
	'AJAX_ERROR_TEXT_PARSERERROR'	=> '请求出错，服务器返回一个无效的响应。',
	'ALLOWED'						=> '允许',
	'ALL_FILES'						=> '全部文件',
	'ALL_FORUMS'					=> '全部版面',
	'ALL_MESSAGES'					=> '全部短信',
	'ALL_POSTS'						=> '全部帖子',
	'ALL_TIMES'						=> '所有显示的时间为 <span title="%2$s">%1$s</span>',
	'ALL_TOPICS'					=> '全部主题',
	'ALT_TEXT'						=> '替换文本',	
	'AND'							=> '和',
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ALREADY_LINKED'				=> '这个外部服务已经联系到其他用户。',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_ENTRY'				=> '无效的数据库记录。',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_SERVICE_TYPE'		=> '提供给 OAuth 服务处理程序的是无效的服务类型。',
	'AUTH_PROVIDER_OAUTH_ERROR_SERVICE_NOT_CREATED'			=> 'OAuth 服务尚未建立',
	'AUTH_PROVIDER_OAUTH_SERVICE_BITLY'						=> 'Bitly',
	'AUTH_PROVIDER_OAUTH_SERVICE_FACEBOOK'					=> 'Facebook',
	'AUTH_PROVIDER_OAUTH_SERVICE_GOOGLE'					=> 'Google',
	'AUTH_PROVIDER_OAUTH_SERVICE_TWITTER'					=> 'Twitter',
	'AUTH_PROVIDER_OAUTH_TOKEN_ERROR_NOT_STORED'			=> 'OAuth 令牌没有储存。',
	'AUTH_PROVIDER_OAUTH_TOKEN_ERROR_INCORRECTLY_STORED'	=> 'OAuth 令牌储存错误。',
	...
	'AVATAR_NO_TEMP_DIR'			=> '临时目录不可写入或者不存在。',	
	'AVATAR_NO_SIZE'				=> '无法自动获取头像的长和宽，请手动输入合适的数值。',
	'AVATAR_PARTIAL_UPLOAD'			=> '上传的文件只上传了一部分',
	'AVATAR_PHP_SIZE_NA'			=> '头像文件太大。<br />无法判断服务器上 php.ini 所允许的最大文件大小。',
	'AVATAR_PHP_SIZE_OVERRUN'		=> '头像文件太大，服务器允许的最大文件大小是 %1$d %2$s。<br />请注意这是由 php.ini 设置所以无法更改。',
	'AVATAR_REMOTE_UPLOAD_TIMEOUT'		=> '指定的头像因请求超时而上传失败。',
	'AVATAR_PHP_UPLOAD_STOPPED'		=> '一个 PHP 扩展阻止了文件上传。',	
	...
	'BACK_TO_TOP'			=> '页首',
	'BACK_TO_PREV'			=> '回到前一页',
	'BAN_TRIGGERED_BY_EMAIL'=> '您的 email 地址已被封禁。',
	'BAN_TRIGGERED_BY_IP'	=> '您的 IP 地址已被封禁。',
	'BAN_TRIGGERED_BY_USER'	=> '您的用户名已被封禁。',
	'BBCODE_GUIDE'			=> 'BBCode 使用指南',
	'BCC'					=> 'BCC',
	'BIRTHDAYS'				=> '生日',
	...
	'COOKIE_CONSENT_MSG'	=> '本站使用 cookies 以提供用户最佳使用体验。',
	'COOKIE_CONSENT_OK'		=> '明白了！',
	'COOKIE_CONSENT_HREF'	=> 'http://cookiesandyou.com',
	'COOKIES_DELETED'		=> '所有的 cookie 都已经被清除。',
	...
	'EMAIL_SMTP_ERROR_RESPONSE'			=> '发送 email 时，在第<strong> %1$s</strong>行出现故障。故障信息： %2$s',
	...
	'EXPAND_VIEW'						=> '展开视图',
	'EXTENSION'							=> '扩展名',
	'EXTENSION_DISABLED'				=> '扩展 <strong>%s</strong> 尚未启用。',
	...
	'FILE_JSON_DECODE_ERR'	=> '解析 json 文件失败： %s',
	...
	'FROM'					=> '从',
	'FSOCK_DISABLED'		=> '操作无法完成，因为 fsock 函数被禁用或者无法找到目标服务器。',
	'FSOCK_TIMEOUT'			=> '读取网络流时发生超时。',

	'FTP_FSOCK_HOST'				=> 'FTP 主机',
	'FTP_FSOCK_HOST_EXPLAIN'		=> '用于连接您的网站的 FTP 服务器',
	'FTP_FSOCK_PASSWORD'			=> 'FTP 密码',
	'FTP_FSOCK_PASSWORD_EXPLAIN'	=> '与您的 FTP 用户名对应的密码',
	'FTP_FSOCK_PORT'				=> 'FTP 端口',
	'FTP_FSOCK_PORT_EXPLAIN'		=> '您的 FTP 服务器的端口',
	...
	'FTP_FSOCK_USERNAME_EXPLAIN'	=> '连接您的 FTP 服务器所用的用户名',

	'FTP_HOST'					=> 'FTP 主机',
	'FTP_HOST_EXPLAIN'			=> '用于连接您的网站的 FTP 服务器',
	'FTP_PASSWORD'				=> 'FTP 密码',
	'FTP_PASSWORD_EXPLAIN'		=> '对应您的 FTP 用户名的密码',
	'FTP_PORT'					=> 'FTP 端口',
	'FTP_PORT_EXPLAIN'			=> '您的 FTP 服务器的端口',
	...
	'FTP_USERNAME_EXPLAIN'		=> '连接您的 FTP 服务器所用的用户名',
	...
	'G_GUESTS'					=> '游客',
	'G_REGISTERED'				=> '注册用户',
	'G_REGISTERED_COPPA'		=> '注册 COPPA 用户',
	...
	'INDEX'						=> '首页',
	'INFORMATION'				=> '信息',
	'INSECURE_REDIRECT'			=> '尝试重定向到可能不安全的网址。',
	'INTERESTS'					=> '兴趣',
	'INVALID_DIGEST_CHALLENGE'	=> '无效的摘要需求。',
	'INVALID_EMAIL_LOG'			=> '<strong>%s</strong> 可能无效的 email 地址？',
	'INVALID_FEED_ATTACHMENTS'	=> '所选择的 Feed 尝试用无效的参数来提取附件。',
	'INVALID_PLURAL_RULE'		=> '所选复数规则是无效的，有效值是 0 到 15 之间的整数。',
	'IP'						=> 'IP',
	...
	'LOGIN_ERROR_OAUTH_SERVICE_DOES_NOT_EXIST'	=> '一个不存在的 OAuth 服务被请求。',
	...
	'NOTIFICATION_GROUP_REQUEST'		=> '<strong>加入用户组申请</strong>来自 %1$s ， 申请加入用户组 %2$s。',
	'NOTIFICATION_GROUP_REQUEST_APPROVED'	=> '<strong>用户组请求申请批准</strong>加入用户组 %1$s。',
	'NOTIFICATION_METHOD_INVALID'		=> ' "%s" 不是一个有效的通知方法。',
	'NOTIFICATION_PM'					=> '来自 %1$s 的<strong>站内短信</strong>：',
	'NOTIFICATION_POST'					=> array(
		1	=> '<strong>回复</strong>从 %1$s 在主题：',
	),
	'NOTIFICATION_POST_APPROVED'		=> '<strong>帖子审核批准</strong>：',
	'NOTIFICATION_POST_DISAPPROVED'		=> '<strong>帖子审核被拒绝</strong>：',
	'NOTIFICATION_POST_IN_QUEUE'		=> '<strong>帖子审核</strong>来自 %1$s：',
	'NOTIFICATION_QUOTE'				=> array(
		1	=> '<strong>引用</strong> 由 %1$s 在:',
	),
	'NOTIFICATION_REFERENCE'			=> '"%1$s"',
	'NOTIFICATION_REASON'				=> '<em>原因：</em> %1$s。',
	'NOTIFICATION_REPORT_PM'			=> '<strong>站内短信举报</strong>由 %1$s：',
	'NOTIFICATION_REPORT_POST'			=> '<strong>帖子举报</strong>由 %1$s：',
	'NOTIFICATION_REPORT_CLOSED'		=> '<strong>举报关闭</strong>由 %1$s 为：',
	'NOTIFICATION_TOPIC'				=> '<strong>新主题</strong>由 %1$s：',
	'NOTIFICATION_TOPIC_APPROVED'		=> '<strong>主题审核已批准</strong>：',
	'NOTIFICATION_TOPIC_DISAPPROVED'	=> '<strong>主题审核被拒绝</strong>：',
	'NOTIFICATION_TOPIC_IN_QUEUE'		=> '<strong>主题审核</strong>由 %1$s：',
	'NOTIFICATION_TYPE_NOT_EXIST'		=> '通知类型 "%s" 从文件系统丢失。',
	'NOTIFICATION_ADMIN_ACTIVATE_USER'	=> '<strong>激活请求</strong>来自于新注册或被禁用的用户: “%1$s”',
	...
	'NO_STYLE_DATA'				=> '无法获得样式数据',
	'NO_STYLE_CFG'				=> '无法获取样式配置文件： %s',
	...
	'POSTING_PRIVATE_MESSAGE'	=> '编写站内短信',
	'POST'					=> '帖子',
	...
	'POSTS_UNAPPROVED_FORUM'=> '至少一个帖子在此论坛未获批准。',
	'POST_BY_AUTHOR'		=> '由',
	...
	'READ_PROFILE'				=> '用户资料',
	'REASON'					=> '原因',
	'RECORD_ONLINE_USERS'		=> '最高在线记录：<strong>%1$s</strong>，生成于 %2$s',
	'REDIRECT'					=> '重定向',
	'REDIRECTS'					=> '总共转向',
	'REGISTER'					=> '注册',
	...
	'SELECT_FORUM'				=> '选择一个版面',
	'SEND_EMAIL'				=> '发送 Email',
	'SEND_EMAIL_USER'			=> '发送 email 到 %s',
	'SEND_PRIVATE_MESSAGE'		=> '发送站内短信',
	'SETTINGS'					=> '设置',
	'SIGNATURE'					=> '签名',
	'SKIP'						=> '跳到内容',
	'SKYPE'						=> 'Skype',
	'SMTP_NO_AUTH_SUPPORT'		=> 'SMTP 服务器不支持验证',
	...
	'TOO_LARGE'                     => '您输入的值太大了。',
	'TOO_LARGE_MAX_RECIPIENTS'      => '您输入的<strong>每个站内短信的最大收件人数目</strong> 太大。',
	...
	'TOTAL_POSTS_COUNT'	=> array(
		1	=> '帖子总数 <strong>%d</strong>',
	),
	'TOPIC_REPORTED'	=> '此主题已被举报',
	'TOTAL_TOPICS'		=> array(
		1	=> '主题总数 <strong>%d</strong>',
	),
	'TOTAL_USERS'		=> array(
		1	=> '用户总数 <strong>%d</strong>',
	),
	'TRACKED_PHP_ERROR'	=> '记载的 PHP 错误: %s',
	'TWITTER'			=> 'Twitter',

	'UNABLE_GET_IMAGE_SIZE'	=> '无法浏览图片，或者此文件不是一个有效的图片文件。请检查你输入的 URL 是否正确。',
	'UNABLE_TO_DELIVER_FILE'=> '无法传送文件。',
	'UNKNOWN_BROWSER'		=> '无法浏览',
	'UNMARK_ALL'			=> '取消全选',
	'UNREAD_MESSAGES'		=> '未读站内短信',
	'UNREAD_POST'           => '未读帖子',
	'UNREAD_POSTS'          => '未读帖子',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> '抱歉!您没有权限使用这个功能。您可能刚在本站注册，需要更多的参与到讨论中去才能使用这些功能。',
	...
	'VIEWING_PRIVATE_MESSAGES'	=> '查看站内短信',
	...
	'default_dateformat'	=> '|Y年 M j日| H:i', // 2007-01-01 13:37
