...
$lang = array_merge($lang, array(
	...
	'ACL_U_SENDPM'		=> '可以发送站内短信',
	'ACL_U_MASSPM'		=> '可以群发私人短信给用户',
	'ACL_U_MASSPM_GROUP'=> '可以群发死人短信给用户组',
	'ACL_U_READPM'		=> '可以阅读站内短信',
	'ACL_U_PM_EDIT'		=> '可以编辑自己的站内短信',
	'ACL_U_PM_DELETE'	=> '可以删除自己的站内短信',
	'ACL_U_PM_FORWARD'	=> '可以转发站内短信',
	'ACL_U_PM_EMAILPM'	=> '可以 email 站内短信',
	'ACL_U_PM_PRINTPM'	=> '可以打印站内短信',
	'ACL_U_PM_ATTACH'	=> '可以在短信中添加附件',
	'ACL_U_PM_DOWNLOAD'	=> '可以在短信中下载附件',
	'ACL_U_PM_BBCODE'	=> '可以在短信中使用 BBCode',
	'ACL_U_PM_SMILIES'	=> '可以在短信中使用表情图标',
	'ACL_U_PM_IMG'		=> '可以在短信中粘贴图片',
	'ACL_U_PM_FLASH'	=> '可以在短信中粘贴 Flash',

	'ACL_U_SENDEMAIL'	=> '可以发送 email',
...
$lang = array_merge($lang, array(
	'ACL_F_LIST'		=> '可以看见版面',
	'ACL_F_LIST_TOPICS' => '可以查看主题',
	'ACL_F_READ'		=> '可以浏览版面',
	'ACL_F_SEARCH'		=> '可以搜索版面',
	'ACL_F_SUBSCRIBE'	=> '可以订阅版面',
	'ACL_F_PRINT'		=> '可以打印主题',
	'ACL_F_EMAIL'		=> '可以 email 主题',
	'ACL_F_BUMP'		=> '可以顶主题',
	...
	'ACL_F_ANNOUNCE_GLOBAL'	=> '可以发布全局公告',
	'ACL_F_REPLY'		=> '可以回复主题',
...
$lang = array_merge($lang, array(
	...
	'ACL_M_PM_REPORT'	=> '可以关闭和删除站内短信报告<br /><em>这是全局设置，与版面无关。</em>', // This moderator setting is only global (and not local)
...
$lang = array_merge($lang, array(
	...
	'ACL_A_JABBER'		=> '可以修改 Jabber 设定',
	'ACL_A_PHPINFO'		=> '可以查看 php 设定',
