...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> '日期格式和 PHP 定义相同 <code><a href="https://secure.php.net/manual/function.date.php">date()</a></code> 函数。',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_REMOTE_EXPLAIN'			=> '从其他网站链接的头像。<br><em><strong class="error">警告：</strong> 启用此特性可能会允许用户检查某些只允许局域网访问的文件和服务存在与否。</em>',
	'ALLOW_REMOTE_UPLOAD'			=> '允许远程上传头像',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> '允许会员上传来自另一个网站的头像。<br><em><strong class="error">警告：</strong> 启用此特性可能会允许用户检查某些只允许局域网访问的文件和服务存在与否。</em>',
	'ALLOW_UPLOAD'					=> '允许头像上传',
...
$lang = array_merge($lang, array(
	...
	'EMAIL_MAX_CHUNK_SIZE'			=> '允许的最大收件人人数',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> '如果需要的话，设置此值小于你的邮件服务器所能允许的单个邮件之最多收件人数值。',
	'EMAIL_SIG'						=> 'Email 签名',
	...
	'SMTP_SERVER_EXPLAIN'			=> '不要提供协议，（<samp>ssl://</samp> 或者 <samp>tsl://</samp>），除非你的邮件服务商要求你这么做。',
