...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000026533000007fdfead337cc(
...
class phpbbtemplatetwiglexer_000000000026533000007fdfead337cc extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5de5e99cba303756893627 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5de5e99cba314784344128 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5de5e99cba2da678165180 = array(
    ...
    {
        $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, 'set_environment', array('env' => $env), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;

        return $this->valueHolder5de5e99cba303756893627->set_environment($env);
    }
    ...
    {
        $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;

        return $this->valueHolder5de5e99cba303756893627->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;

        return $this->valueHolder5de5e99cba303756893627->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5de5e99cba314784344128 = $initializer;
    }
    ...
    {
        $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, '__get', array('name' => $name), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;

        if (isset(self::$publicProperties5de5e99cba2da678165180[$name])) {
            return $this->valueHolder5de5e99cba303756893627->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5de5e99cba303756893627;
    ...
    {
        $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;
    ...
    {
        $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, '__isset', array('name' => $name), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;
    ...
    {
        $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, '__unset', array('name' => $name), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;
    ...
    {
        $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, '__clone', array(), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;

        $this->valueHolder5de5e99cba303756893627 = clone $this->valueHolder5de5e99cba303756893627;
    }

    public function __sleep()
    {
        $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, '__sleep', array(), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;

        return array('valueHolder5de5e99cba303756893627');
    }
    ...
    {
        return $this->initializer5de5e99cba314784344128;
    }
    ...
    {
        return $this->initializer5de5e99cba314784344128 && ($this->initializer5de5e99cba314784344128->__invoke($valueHolder5de5e99cba303756893627, $this, 'initializeProxy', array(), $this->initializer5de5e99cba314784344128) || 1) && $this->valueHolder5de5e99cba303756893627 = $valueHolder5de5e99cba303756893627;
    }
    ...
    {
        return null !== $this->valueHolder5de5e99cba303756893627;
    }
    ...
    {
        return $this->valueHolder5de5e99cba303756893627;
    }
