...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006d62a9b000007fdfea26b2a6(
...
class phpbbtemplatetwiglexer_000000006d62a9b000007fdfea26b2a6 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5de5e9a6d93af367298788 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5de5e9a6d93bc647218807 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5de5e9a6d938d963477874 = array(
    ...
    {
        $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, 'set_environment', array('env' => $env), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;

        return $this->valueHolder5de5e9a6d93af367298788->set_environment($env);
    }
    ...
    {
        $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;

        return $this->valueHolder5de5e9a6d93af367298788->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;

        return $this->valueHolder5de5e9a6d93af367298788->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5de5e9a6d93bc647218807 = $initializer;
    }
    ...
    {
        $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, '__get', array('name' => $name), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;

        if (isset(self::$publicProperties5de5e9a6d938d963477874[$name])) {
            return $this->valueHolder5de5e9a6d93af367298788->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5de5e9a6d93af367298788;
    ...
    {
        $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;
    ...
    {
        $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, '__isset', array('name' => $name), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;
    ...
    {
        $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, '__unset', array('name' => $name), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;
    ...
    {
        $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, '__clone', array(), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;

        $this->valueHolder5de5e9a6d93af367298788 = clone $this->valueHolder5de5e9a6d93af367298788;
    }

    public function __sleep()
    {
        $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, '__sleep', array(), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;

        return array('valueHolder5de5e9a6d93af367298788');
    }
    ...
    {
        return $this->initializer5de5e9a6d93bc647218807;
    }
    ...
    {
        return $this->initializer5de5e9a6d93bc647218807 && ($this->initializer5de5e9a6d93bc647218807->__invoke($valueHolder5de5e9a6d93af367298788, $this, 'initializeProxy', array(), $this->initializer5de5e9a6d93bc647218807) || 1) && $this->valueHolder5de5e9a6d93af367298788 = $valueHolder5de5e9a6d93af367298788;
    }
    ...
    {
        return null !== $this->valueHolder5de5e9a6d93af367298788;
    }
    ...
    {
        return $this->valueHolder5de5e9a6d93af367298788;
    }
