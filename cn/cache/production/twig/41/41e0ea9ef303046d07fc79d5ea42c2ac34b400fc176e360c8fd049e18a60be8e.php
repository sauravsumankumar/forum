...
/* faq_body.html */
class __TwigTemplate_f42ed242620948e36a423624ac763aba21e4f4c19efbb2d8fd197dea88ef296c extends \Twig\Template
{
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["faq_block"]) {
            // line 10
            echo "\t\t\t";
            if (($this->getAttribute($context["faq_block"], "SWITCH_COLUMN", []) || ((isset($context["SWITCH_COLUMN_MANUALLY"]) ? $context["SWITCH_COLUMN_MANUALLY"] : null) && ($this->getAttribute($context["faq_block"], "S_ROW_COUNT", []) == 4)))) {
                // line 11
                echo "\t\t\t\t</div>
