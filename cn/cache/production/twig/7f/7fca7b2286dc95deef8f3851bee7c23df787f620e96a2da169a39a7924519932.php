...
/* acp_styles.html */
class __TwigTemplate_074b41b17f115b9619c1c3c587c3e6edde56cc1f1d18bb38621275e3bc44ddf6 extends \Twig\Template
{
...
\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["parent_styles"]) {
                    ...
                    echo "\"";
                    if (($this->getAttribute($context["parent_styles"], "STYLE_ID", []) == (isset($context["STYLE_PARENT"]) ? $context["STYLE_PARENT"] : null))) {
                        echo " selected=\"selected\"";
                    }
                    echo ">";
