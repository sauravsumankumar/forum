...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002c64d00900007f30a3f76e97(
...
class phpbbtemplatetwiglexer_000000002c64d00900007f30a3f76e97 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5de5c44c92ae1805599874 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5de5c44c92aef965788367 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5de5c44c92abe822798428 = array(
    ...
    {
        $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, 'set_environment', array('env' => $env), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;

        return $this->valueHolder5de5c44c92ae1805599874->set_environment($env);
    }
    ...
    {
        $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;

        return $this->valueHolder5de5c44c92ae1805599874->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;

        return $this->valueHolder5de5c44c92ae1805599874->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5de5c44c92aef965788367 = $initializer;
    }
    ...
    {
        $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, '__get', array('name' => $name), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;

        if (isset(self::$publicProperties5de5c44c92abe822798428[$name])) {
            return $this->valueHolder5de5c44c92ae1805599874->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5de5c44c92ae1805599874;
    ...
    {
        $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;
    ...
    {
        $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, '__isset', array('name' => $name), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;
    ...
    {
        $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, '__unset', array('name' => $name), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;
    ...
    {
        $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, '__clone', array(), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;

        $this->valueHolder5de5c44c92ae1805599874 = clone $this->valueHolder5de5c44c92ae1805599874;
    }

    public function __sleep()
    {
        $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, '__sleep', array(), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;

        return array('valueHolder5de5c44c92ae1805599874');
    }
    ...
    {
        return $this->initializer5de5c44c92aef965788367;
    }
    ...
    {
        return $this->initializer5de5c44c92aef965788367 && ($this->initializer5de5c44c92aef965788367->__invoke($valueHolder5de5c44c92ae1805599874, $this, 'initializeProxy', array(), $this->initializer5de5c44c92aef965788367) || 1) && $this->valueHolder5de5c44c92ae1805599874 = $valueHolder5de5c44c92ae1805599874;
    }
    ...
    {
        return null !== $this->valueHolder5de5c44c92ae1805599874;
    }
    ...
    {
        return $this->valueHolder5de5c44c92ae1805599874;
    }
