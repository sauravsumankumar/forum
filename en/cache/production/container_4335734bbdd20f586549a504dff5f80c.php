...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007ef57cd400007f30b1d68451(
...
class phpbbtemplatetwiglexer_000000007ef57cd400007f30b1d68451 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5de5c44563b3c211492752 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5de5c44563b4b223549238 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5de5c44563b15015765578 = array(
    ...
    {
        $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, 'set_environment', array('env' => $env), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;

        return $this->valueHolder5de5c44563b3c211492752->set_environment($env);
    }
    ...
    {
        $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;

        return $this->valueHolder5de5c44563b3c211492752->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;

        return $this->valueHolder5de5c44563b3c211492752->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5de5c44563b4b223549238 = $initializer;
    }
    ...
    {
        $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, '__get', array('name' => $name), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;

        if (isset(self::$publicProperties5de5c44563b15015765578[$name])) {
            return $this->valueHolder5de5c44563b3c211492752->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5de5c44563b3c211492752;
    ...
    {
        $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;
    ...
    {
        $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, '__isset', array('name' => $name), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;
    ...
    {
        $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, '__unset', array('name' => $name), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;
    ...
    {
        $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, '__clone', array(), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;

        $this->valueHolder5de5c44563b3c211492752 = clone $this->valueHolder5de5c44563b3c211492752;
    }

    public function __sleep()
    {
        $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, '__sleep', array(), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;

        return array('valueHolder5de5c44563b3c211492752');
    }
    ...
    {
        return $this->initializer5de5c44563b4b223549238;
    }
    ...
    {
        return $this->initializer5de5c44563b4b223549238 && ($this->initializer5de5c44563b4b223549238->__invoke($valueHolder5de5c44563b3c211492752, $this, 'initializeProxy', array(), $this->initializer5de5c44563b4b223549238) || 1) && $this->valueHolder5de5c44563b3c211492752 = $valueHolder5de5c44563b3c211492752;
    }
    ...
    {
        return null !== $this->valueHolder5de5c44563b3c211492752;
    }
    ...
    {
        return $this->valueHolder5de5c44563b3c211492752;
    }
